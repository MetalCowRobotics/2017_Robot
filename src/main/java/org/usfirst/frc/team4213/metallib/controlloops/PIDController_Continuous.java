 ...
 * @author hughest1
 */
public class PIDController_Continuous extends ErrorController {
	...
	public PIDController_Continuous(String name, double kp, double ki, double kd, double integralLifespan) {
		super(name);
		this.kp = kp;
		this.ki = ki;
